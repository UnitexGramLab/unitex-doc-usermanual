...
dows que sous Linux ou OS X. Ce chapitre décrit l’installation et le lancement d’Unitex
...
\item la bibliothèque wingetopt de Todd Miller et de la Fondation NetBSD, sous licence
BSD license, plus permissive que la licence LPGL~;
...
\bigskip
\noindent Décompressez le fichier \index{Fichier!\verbc{Unitex3.1beta.zip}} \verb+Unitex3.1beta.zip+ (ou \verb+Unitex3.0.zip+)
...
le répertoire système Unitex.\index{Répertoire!système Unitex}\index{Dossier|see{Répertoire}}
