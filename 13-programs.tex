...
\end{verbatim}
This will allow you to load .bin, .fst2 and alphabet files and to keep them in memory persistently.

\begin{verbatim}
UnitexJni.loadPersistentAlphabet("/.../unitex/French/Alphabet.txt");
UnitexJni.loadPersistentFst2("/.../unitex/French/Dela/fogg-r.fst2");
UnitexJni.loadPersistentDictionary(
