...
\subsection{Fichier (user login).cfg et .unitex.cfg}
...
permet de lancer Unitex tantôt sous Linux, tantôt sous Windows~: le chemin Windows vers le
répertoire Unitex personnel est indiqué dans .unitex.cfg, et Unitex l’ignore quand on le lance
sous Linux.}.
...
\verb+(user login).cfg+ dans le sous-répertoire \verb+Users+ du répertoire Unitex système. Si l’utilisateur
