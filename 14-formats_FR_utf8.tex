...
Les fichiers d'offsets de différence sont écrit par l'outils Unxmlize, lu par Tokenize, lu et écrit par DumpOffsets, Normalize, Fst2Txt, Tokenize, Concord et GrfTest.
\bigskip
...
Les fichiers d'offsets de zone commune sont écrit par Tokenize et lu par Concord.
\bigskip
Ces fichiers textes sont constituées de lignes contenant 3 entiers A B C et de texte entre < et >. Chaque ligne correspond à un token, exprimée de la façon suivante:
