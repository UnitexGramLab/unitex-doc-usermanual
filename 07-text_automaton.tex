...
%	\item as explained in \ref{dictionary-variables} you can use information
%	extracted from a lexical tag contained in the text-automaton, 
%	without being in morphologicalmode.
	\item if the text automaton contains morphological analysis, you can get inflected form, lemma and codes of the entry with variables defined as in section~\ref{dictionary-variables}.
