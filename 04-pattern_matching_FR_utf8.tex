...
\begin{itemize}
  ...
  \item \verb+<WORD>+ : reconnaît n’importe quelle unité lexicale formée de lettres (l'ancien masque <MOT> reste toujours valable);
  \item \verb+<LOWER>+ : reconnaît n’importe quelle unité lexicale formée de lettres minuscules (l'ancien masque <MIN> reste toujours valable);
  \item \verb+<UPPER>+ : reconnaît n’importe quelle unité lexicale formée de lettres majuscules (l'ancien masque <MAJ> reste toujours valable);
  \item \verb+<FIRST>+ : reconnaît n’importe quelle unité lexicale formée de lettres et commençant par
  	  une
majuscule (l'ancien masque <PRE> reste toujours valable);
