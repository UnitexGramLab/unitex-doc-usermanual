...
\verb+<MAJ>+,
\verb+<PRE>+\footnote{Et sur leurs équivalents anglais  <WORD>, <LOWER>, <UPPER>, 
<FIRST>. Voir section~\ref{section-special-symbols}.},
...
\verb+<!DIC>+, \verb+<!MIN>+, \verb+<!MAJ>+ et
\verb+<!PRE>+\footnote{Et dans leurs équivalents anglais <LOWER>, <UPPER> et
<FIRST>. Voir section~\ref{section-special-symbols}.}.
