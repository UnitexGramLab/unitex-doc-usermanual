...
\index{\verb+<E>+}\index{\verb+<NB>+}\index{\verb+#+} The
...
\index{\verb+<LOWER>+}\index{\verb+<UPPER>+}\index{\verb+<FIRST>+}
...
\begin{itemize}
  ...
  \index{\verb+{S}+}\index{Sentence delimiter}\index{\verb+{STOP}+}
\end{itemize}
...
\section{Union}
\index{Union of regular expressions}\index{\verb$+$}
...
\section{Kleene star}
\index{Kleene star}\index{\verb+*+}\index{Operator!Kleene star}\index{Operator!iteration}
