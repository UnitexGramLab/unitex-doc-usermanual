...
\item the box with the lexical mask is common to more paths than the boxes searching for the semantic codes
in the dictionary-entry variable.\footnote{Thus, the lexical mask provokes a search in morphological-mode dictionaries
