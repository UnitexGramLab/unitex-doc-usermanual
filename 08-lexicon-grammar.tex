...
\index{LADL} (\cite{L}, \cite{BGL}, \cite{methodes-en-syntaxe}, \cite{GL}) based
...
window as shown on Figure \ref{sauvegarde-csv}. Choose "Unicode", select
tabulation as column separator and do not set any text delimiter.
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=12cm]{resources/img/fig8-2.png}
\caption{Saving a table with OpenOffice.org Calc\label{sauvegarde-csv}}
\end{center}
\end{figure}
...
\bigskip
\noindent Figure \ref{fig-graphe-patron} shows an example of a parameterized graph
designed to be applied to the lexicon-grammar table 31H presented in figure
\ref{fig-exemple-table}.
\begin{figure}[!h]
\begin{center}
\includegraphics[width=15cm]{resources/img/fig8-3.png}
\caption{Example of parameterized graph\label{fig-graphe-patron}}
\end{center}
\end{figure}
...
\caption{Lexicon-grammar table 31H\label{fig-exemple-table}}
\end{center}
\end{figure}
...
"Lexicon-Grammar" menu (see figure \ref{fig-menu-lexicon-grammar}). The table
must be in Unicode text format.
\begin{figure}[!h]
\begin{center}
\includegraphics[width=12cm]{resources/img/fig8-5.png}
\caption{Menu "Lexicon-Grammar"\label{fig-menu-lexicon-grammar}}
\end{center}
\end{figure}

\bigskip
\noindent The selected table is then displayed in a window (see figure figure
\ref{fig-affichage-table}). If it does not appear on your screen, it may be
hidden by other Unitex windows.
\begin{figure}[!h]
\begin{center}
\includegraphics[width=15cm]{resources/img/fig8-6.png}
\caption{Displaying a table\label{fig-affichage-table}}
\end{center}
\end{figure}
...
\ref{fig-configuration-génération-graphes} shows this.
\begin{figure}[!h]
\begin{center}
\includegraphics[width=9cm]{resources/img/fig8-7.png}
\caption{Configuration of the automatic generation of graphs\label{fig-configuration-génération-graphes}}
\end{center}
\end{figure}
...
\bigskip
\noindent Figures \ref{fig-graphe-archaïser} and \ref{fig-graphe-badauder} show
two graphs generated by applying the parameterized graph of figure
\ref{fig-graphe-patron} at table 31H.

\bigskip
\noindent Figure \ref{fig-graphe-principal} shows the resulting main graph.
\begin{figure}[!h]
\begin{center}
\includegraphics[width=15cm]{resources/img/fig8-8.png}
\caption{Graph generated for the verb \texttt{archaïser}\label{fig-graphe-archaïser}}
\end{center}
\end{figure}
...
\caption{Graph generated for the verb \texttt{badauder}\label{fig-graphe-badauder}}
\end{center}
\end{figure}
...
\caption{Main graph referring to all the generated graphs\label{fig-graphe-principal}}
\end{center}
\end{figure}
