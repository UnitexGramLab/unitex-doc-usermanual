...
l’on comprime les dictionnaires. \index{Commentaire!dans un dictionnaire} \index{Dictionnaire!commentaire}\index{\verb+/+}
\end{itemize}
...
\begin{itemize}
\item \verb+L+ (left)\index{\verb+L+}\index{Opérateur!\verb+L+} enlève une lettre à l’entrée;
  	  
\item \verb+R+ (right)\index{\verb+R+}\index{Opérateur!\verb+R+}
...
\item \verb+C+ (copy)\index{\verb+C+}\index{Opérateur!\verb+C+}
...
\verb+C+ afin de dupliquer la consonne finale, quelle qu’elle soit;
  ...
  \item \verb+D+ (delete)\index{\verb+D+}\index{Opérateur!\verb+D+}
...
\item \verb+U+ (unaccent)\index{\verb+U+}\index{Opérateur!\verb+U+}
...
\item \verb+J+ \index{\verb+J+}\index{Opérateur!\verb+J+}
...
\item \verb+.+ (latin dot)\index{\verb+.+}\index{Opérateur!\verb+.+}
...
Le programme \verb+Dico+\index{\verb+Dico+}\index{Programmes externes!\verb+Dico+} est également capable
