...
possible d’utiliser les filtres morphologiques\index{Filtres morphologiques} et le mode morphologique.\index{Mode
morphologique}
...
dans la mesure où elles n'appartiennent pas à un dictionnaire déclaré comme dictionnaire du mode morphologique.
