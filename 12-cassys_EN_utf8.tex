...
In the case of a token list entry \emph{\{\{A,.y\} \{B,.z\},.x\}} the graph of the figure \ref{fig12-3-01} places in the box \textit{A B} as displayed in the figure \ref{fig12-3-02}.
\begin{figure}[!htb]
  \centering
