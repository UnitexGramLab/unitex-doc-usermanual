...
\begin{itemize}
  \item \verb+L+ (left) removes a letter from the entry.\index{\verb+L+}\index{Operator!\verb+L+}
  
  \item \verb+R+ (right) restores a letter to the entry.\index{\verb+R+}\index{Operator!\verb+R+}
  ...
  \item \verb+C+ (copy)\index{\verb+C+}\index{Operator!\verb+C+}
  ...
  \item \verb+D+ (delete)\index{\verb+D+}\index{Operator!\verb+D+} deletes a
  ...
  \item \verb+U+ (unaccent)\index{\verb+U+}\index{Operator!\verb+U+}
...
\begin{itemize}\index{Jamo}\index{Hangul}
    \item \verb+J+ removes a Jamo letter.\index{\verb+J+}\index{Operator!\verb+J+}
    ...
    \item \verb+.+ (latin dot)\index{\verb+.+}\index{Operator!\verb+.+}
...
\index{External programs!\verb+Dico+}\index{File!\verb+Alphabet.txt+}\index{File!alphabet}\index{Alphabet}
as a parameter.
...
conform to the following rule: if applied by \verb+Locate+\index{\verb+Locate+}\index{External
