...
\item en mode morphologique, si un code sémantique est de la forme xxx = yyy, 
	you can query the attribute value xxx. This matches the inflected form, 
	lemma or codes of the entry variables when the semantic code come from 
	a dictionary (see section~\ref{dictionary-variables}), or any other 
