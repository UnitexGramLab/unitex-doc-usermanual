...
You can set variables to information stored in morphological dictionaries.
The initialization of such a variable must be associated to a box that contains
a pattern referring to information stored in morphological dictionaries,
except the pattern \verb+<DIC>+. Set the output of the box with
...
presents alternatively lines from the two concordance, leaving an empty line when a match
