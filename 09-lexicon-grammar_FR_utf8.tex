...
\index{Lexique-grammaire!tables}\index{Matrices}
...
\index{Graphe paramétré}\index{Graphe!paramétré}
...
\index{Variable!dans des graphes paramétrés}
\bigskip
\noindent Les variables qui font référence aux colonnes sont formées du caractère \verb+@+
\index{\verb+"@+} suivi d’un nom de colonne en lettres majuscules (les colonnes sont numérotées
...
\bigskip
\noindent Il existe également une variable spéciale \verb+@%+ \index{\verb+"@%+} qui est remplacée
