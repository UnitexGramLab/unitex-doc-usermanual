...
\begin{itemize}
  ...
  \item \verb+-t+/\verb+--tolerate+: tolerate unprotected dot and comma;
...
\bigskip
\noindent Select strict syntax checking detect using unprotected dot in inflected form, or unprotected comma in lemma. The tolerate option act like Unitex 2.0 and lower and don't detect them.
