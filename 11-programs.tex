...
\begin{itemize}
  ...
  \item \verb+-p XXX+/\verb+--param_file=XXX+: load a parameters file like unitex_logging_parameters.txt. Incompatible with all others options;
  ...
  \item \verb+-u+/\verb+--store_output_file+: store output file in log;
  \item \verb+-o+/\verb+--no_store_output_file+: don't store output file in log (default);
