...
\bigskip
\noindent The input of this program is the text automaton of the specified \verb+.tfst+. The program applies
...
and inflectional codes (for example, \verb+the.DET:s+ versus \verb+the.DET:p+). That's why the automaton needs to be 
