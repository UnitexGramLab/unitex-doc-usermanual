...
\bigskip
\noindent \textbf{Maximum iteration per token options:}
\begin{itemize}
  \item \verb+-o N+/\verb+--stop_token_count=N+: stop after N iteration on a token;
  \item \verb+-o N,M+/\verb+--stop_token_count=N,M+: emit warning after N iteration on a token
and stop after M iteration.
\end{itemize}
