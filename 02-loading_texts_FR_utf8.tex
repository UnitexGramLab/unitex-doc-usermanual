...
\verb$t$\index{\verb$t$}, marquant la transitivité, il vous suffit de chercher \verb$t$ en cochant
...
\index{Normalisation!des séparateurs}\index{séparateurs}\index{Texte!normalisation}
...
répertoire du texte, \index{Répertoire!texte}
\index{Texte!répertoire} contiendra toutes les données relatives à ce texte.
...
produit le symbole séparateur de phrases \verb+{S}+\index{\verb+{S}+}\index{Séparateur de phrases},
...
\index{Texte!découpage}
\index{Découpage du texte en unités lexicales}
\index{Token}
\index{Découpage}
\label{tokenization}
...
\begin{itemize}
  ...
  \item le marqueur \verb+{STOP}+.\index{\verb${STOP}$} Contrairement au séparateur de phrases
...
\index{Ressources!lexicales|see{Dictionnaires}}
...
Dictionaries".\index{Dictionnaires!sélection par défaut}
...
\index{Norvégien!mots composés}
\index{Analyse des mots composés libres en nor-végien}
\index{Mots!composés!en norvégien}

\index{Allemand!mots composés}
\index{Analyse des mots composés libres en allemand}
\index{Mots!composés!en allemand}

\index{Russe!mots composés}
\index{Analyse des mots composés libres en russe}
\index{Mots!composés!en russe}

\index{Néerlandais!mots composés}
\index{Analyse des mots composés libres en néerlandais}
\index{Mots!composés!en néerlandais}
