...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=15cm]{resources/img/fig2-10_fr.pdf}
...
\begin{itemize}
  ...
  \item \verb+<MOT>+~: reconnaît n’importe quelle suite de lettres~;
  \item \verb+<MIN>+~: reconnaît n’importe quelle suite de lettres minuscules~;
  \item \verb+<MAJ>+~: reconnaît n’importe quelle suite de lettres majuscules~;
  \item \verb+<PRE>+~: reconnaît n’importe quelle suite de lettres commençant par une majuscule~;
