...
\index{Normalisation!des séparateurs}\index{Séparateur}\index{Texte!normalisation}
...
\index{Analyse des mots composés libres!norvégien}
\index{Mots!composés!libres!norvégien}

\index{Allemand!mots composés}
\index{Analyse des mots composés libres!allemand}
\index{Mots!composés!libres!allemand}
...
\index{Analyse des mots composés libres!néerlandais}
\index{Mots!composés!libres!néerlandais}
