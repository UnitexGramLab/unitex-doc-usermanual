...
are to be retained, you copy them into a txt file and if needed you adapt them into an operational script.
...
\bigskip
\noindent You can formalize un script in shell or batch form (Section~\ref{section-batch}),
...
section~\ref{section-creation} et lance
...
inclus dans le package un fichier \verb$VERSION_AAAAMMJJ$ (voir section \ref{section-creation}):
