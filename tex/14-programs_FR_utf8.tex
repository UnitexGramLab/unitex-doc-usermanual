...
et en version C, le fichier fichier\_offset12 résultant aura la correspondance entre les versions A et C.
...
2 fichiers et vérifiera leur cohérence. Ce fichier est destiné à une lecture manuelle, afin d'étudier le contenu
du fichier d'offset
