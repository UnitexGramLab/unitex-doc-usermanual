\chapter*{Appendix C - Xerces2's Apache License}
\index{License!Apache-2.0}\index{Apache-2.0 License}
\addcontentsline{toc}{chapter}{Appendix C - Xerces2's Apache License}
