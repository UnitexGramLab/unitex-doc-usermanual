...
\begin{itemize}
  ...
  \item Enhanced version of \verb$CasSys$: new \verb$csc$ files, suppression of the \verb$Share$ directory, open cascade also by the \verb$FSGraph$ menu, apply graph until fixed point, tagging generalization graphs, last file may be denormalized
