...
\section*{What's new from version 3.2?}
\addcontentsline{toc}{section}{What's new from version 3.2?}
Here are the main new features:
\begin{itemize}
  \item The unxmlizer (Section~\ref{section-Unxmlize}) has additional options.
  \item The exploration of grammar paths (Section~\ref{explore-paths}) has
  additional options.
  \item A few bugs have been fixed and the quality of some parts of the code
  has been improved.
\end{itemize}

\noindent Thanks to Cristian Martínez, Gilles Vollant, Denis Biguenet, Jean-Manuel Erialc and Fabien Lambert-Delavaquerie for their contribution.
