...
\label{transliteration-Arabic}\index{Translittération!arabe}\index{Dictionnaires!translittération}
...
possible d’utiliser les filtres morphologiques\index{Filtre morphologique}
(section~\ref{section-filters}) et le mode morphologique
(section~\ref{section-morphological-mode}).\index{Mode
morphologique}
...
Cependant, toujours dans la fig.~\ref{3-exp4}, \verb+<A>+ ne reconnait pas \textit{ungay}, et
...
\subsection{Graphes-dictionnaires morphologiques}
