...
fichiers portant les mêmes noms que les fichiers d'entrée, suffixés par défaut\footnote{On peut
spécifier un autre suffixe avec l'option \texttt{-x}. Avec l'option \texttt{-e}, l'extension du fichier
d'entrée est retirée avant d'ajouter le suffixe.} par \verb$.result.txt$.
