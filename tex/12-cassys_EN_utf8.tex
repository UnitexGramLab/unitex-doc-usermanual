...
command line with the following syntax: \verb$--standoff=<template file name>$.
The tempate file is a text file with at most 10 sections:
...
\item text signaling the end of the part on an element (or on an element-type pair)
