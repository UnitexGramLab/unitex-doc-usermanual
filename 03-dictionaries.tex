...
In some languages the inflection process can modify to the root of the word.
...
%\bigskip
\noindent
Note that the factor \verb+$+ which remains in the inflected form is of variable length (\verb+g+, \verb+ch+). 
