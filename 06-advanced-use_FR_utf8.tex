...
Vous pouvez associer des variables aux motifs qui font référence aux dictionnaires morphologiques,
...
Une fois cela fait, il est possible d'obtenir la forme canonique et les informations sur l'entrée avec
...
\item \verb+$xxx.CODE.ATTR=yyy$+ renvoie la valeur \verb+zzz+ de l'attribut \verb+yyy+ si un  code sémantique de la forme \verb+yyy=zzz+ existe.
...
les informations associées à une  étiquette lexicale contenue dans l'automate du texte.
