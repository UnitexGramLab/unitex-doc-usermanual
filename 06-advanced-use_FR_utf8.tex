...
\index{Graphe!syntaxique}\index{Grammaires!locales}
...
\item \verb+<DIC>+ reconnaît n'importe quel mot présent dans un dictionnaire du mode
	 morphologique\index{\verb+<DIC>+}, mais les méta-symboles \verb+#+, \verb+<PRE>+, \verb+<NB>+,
 	 \verb+<SDIC>+ et\verb+<CDIC>+ sont interdits.\index{\verb+#+}\index{\verb+<PRE>+}\index{\verb+<NB>+} \index{\verb+<TOKEN>+}\index{\verb+<SDIC>+} \index{\verb+<CDIC>+}
...
sur les dictionnaires du texte. C'est la raison pour laquelle on doit définir une liste de
...
comme dans \cite{paumier:nam:2014}, page~486.
