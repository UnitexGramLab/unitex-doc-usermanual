...
\noindent En outre, les variables de dictionnaire peuvent être utilisées en dehors du mode morphologique,
...
supplémentaire. 
Même sans être en mode morphologique, on peut mémoriser dans une variable de dictionnaire
