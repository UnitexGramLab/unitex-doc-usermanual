...
\verb+Usage: DumpOffsets [OPTIONS] <txt>+
...
\bigskip
\bigskip
\noindent \verb+Other Usage: DumpOffsets [OPTIONS] <txt>+

\noindent \verb+<txt>: an offset file to read+

\bigskip
\noindent Merge two offset file produced by two successive modification of text 
...
\bigskip
\bigskip
\noindent \verb+Other Usage: DumpOffsets [-v/--convert_modified_to_common] [OPTIONS] <txt>+
...
\bigskip
\bigskip
\noindent \verb+Other Usage: DumpOffsets -o <list_of_position_file_to_read.txt>+
...
Using \verb+-t+ instead \verb+-T+ will do the reverse translation 	 
...
\index{Automaton!of the text}\index{Text!automaton}
...
\index{Automaton!of the text}\index{Text!automaton}\index{File!\verb+.snt+}
